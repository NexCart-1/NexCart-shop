...
import { Instagram, PartyPopper, Package, MessageCircle } from 'lucide-react';
      ...
      >
        ...
        <div className="p-6 sm:p-8">
          ...
          <a
            ...
            className="mt-4 inline-flex w-full items-center justify-center gap-2 px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl font-bold text-sm shadow-lg transition-colors"
          >
            <MessageCircle size={20} />
            Message on WhatsApp for Order Details
          </a>
